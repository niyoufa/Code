...
var HomeTopNav = React.createClass({displayName: "HomeTopNav",
	render : function(){
		return (
			React.createElement("div", {className: "homeNav"}, 
		...
		return (
			React.createElement("div", {className: "myUnit"}, 
				...
				React.createElement("div", {className: "myLevel"}, 
					React.createElement("div", {className: "mycontribution"}, React.createElement("span", null, "贡献值 :"), React.createElement("span", {className: "contribution"})), 
					React.createElement("div", {className: "mylevel"}, React.createElement("span", null, "贡献值 :"), React.createElement("span", {className: "level"}, "L1")), 
					React.createElement("div", {className: "clear"})
				), 
				React.createElement("div", {className: "myPublishList"}, 
					React.createElement("span", {className: "publishCout"}, "0"), 
		...
		return (
			React.createElement("div", {className: "blog"}, 
				...
				React.createElement("div", {className: "blogOperate"}, 
					React.createElement("img", {src: "/static/images/default.png"}), 
					React.createElement("span", {className: "likedCout"}), 
					React.createElement("img", {src: "/static/images/default.png"}), 
					React.createElement("span", {className: "commentCout"})
				), 
				React.createElement("div", {className: "blogSource"}), 
				React.createElement("div", {className: "clear"})
			)
		)
	}
...
//成长页面
HomeUnit = React.createClass({displayName: "HomeUnit",
	render : function() {
		return (
