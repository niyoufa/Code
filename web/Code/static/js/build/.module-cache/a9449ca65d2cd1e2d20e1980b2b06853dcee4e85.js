			...
			React.createElement("div", {className: "registerBody"}, 
				React.createElement("div", {className: "registerBodyInput"}, 
					React.createElement("div", null, 
						React.createElement("input", {type: "text", placeholder: "邮箱", className: "registerBodyInputEmail"})
					), 
					React.createElement("div", null, 
						React.createElement("input", {type: "password", placeholder: "密码", className: "registerBodyInputPassword"})
					), 
					React.createElement("div", null, 
						React.createElement("input", {type: "text", placeholder: "昵称", className: "registerBodyInputNick"})
					)
