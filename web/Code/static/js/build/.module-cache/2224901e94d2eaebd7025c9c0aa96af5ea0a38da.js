		...
		return (
			React.createElement("div", {className: "basicInfoSEXANDADDR"}, 
				React.createElement("div", {className: "basicInfoSEX"}, 
					React.createElement("div", {className: "sex"}, React.createElement("select", null, "性别")), 
					React.createElement("div", {className: "sex_icon"}, React.createElement("img", {src: "/static/images/default.png"})), 
					React.createElement("div", {className: "clear"}), 

					React.createElement("div", {className: "address"}, React.createElement("input", {type: "text", placeholder: "地址"})), 
					React.createElement("div", {className: "sex_icon"}, React.createElement("img", {src: "/static/images/default.png"})), 
					React.createElement("div", {className: "clear"})
				), 
